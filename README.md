...
<!-- Mejoras a lo enviado -->
Tuve grandes dificultades con flex y grid, por tanto me hubiera gustado mejorar en ese aspecto,
tambien el tema de las animaciones que me hubiera gustado utilizar y los colores (amen de haber utilizado la paleta
"prestada" de algunas paginas oficiales de capcom afines al juego).

<!-- Que haria si tuviera mas tiempo -->
ademas de lo mencionado anteriormente, darle mas dinamismo y aplicar mejores tecnicas. Es un 
mundo muy extenso css.
Mejorar las medias queries, tuve serias complicaciones en resoluciones muy especificas.
